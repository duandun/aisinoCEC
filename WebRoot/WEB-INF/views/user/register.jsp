	    ...
	    <form:form id="registerForm" action="" method="post" style="width:300px;">
		  		...
		  		<div class="control-group">
							...
							<div class="controls">
						 		<input type="text"  class="form-control" tabindex="1" name="userName" id="userName" 
						 			...
						 			data-val-remote="该用户已注册。" data-val-remote-additionalfields="*.userName" data-val-remote-url="<%=path %>user/userNameCheck.html">
							<span class="help-block">
							<span data-valmsg-replace="true" data-valmsg-for="userName" class="field-validation-valid">
							</span>
							</span>
							</div>
			    ...
			    <label for="userEmail" class="control-label">电子邮箱</label>
			          <div class="controls">
				           <input type="text" class="form-control" tabindex="4" name="userEmail" id="userEmail" placeholder="123@example.com"
				           			...
				           			data-val-remote="该邮箱已注册。" data-val-remote-additionalfields="*.userEmail" data-val-remote-url="<%=path %>user/userEmailCheck.html" >
				       	 <span class="help-block"><span data-valmsg-replace="true" data-valmsg-for="userEmail" class="field-validation-valid"></span></span>
				       </div>
		  	...
		  	<div class="control-group">
				<label class="control-label">密码</label>
				       <div class="controls">
				      	...
				      	<span class="help-block"><span data-valmsg-replace="true" data-valmsg-for="userPasswd" class="field-validation-valid"></span></span>
				       </div>
			...
			<div class="control-group">
				 <label class="control-label">重复密码</label>
				        ...
				        <span class="help-block"><span data-valmsg-replace="true" data-valmsg-for="userRePasswd" class="field-validation-valid"></span></span>
				        </div>
			...
			<div class="control-group verification">
				<label class="control-label">验证码</label>
					<div class="controls">
						...
						<span class="help-block"><span data-valmsg-replace="true" data-valmsg-for="captchaCode" class="field-validation-valid"></span></span>
						<img id="verificationCodeImg" name="verificationCodeImg" src="<%=path %>util/captcha" title="点击刷新" alt="验证码">
					</div>
			...
			<div class="form-group form-info" style="margin-left:20px;">
				<div class="checkbox checkagreement">
					 <input id="agreement" name="agreement" type="checkbox" value="" checked="checked" />
					  ...
					  <button class="btn btn-primary btn-agreement" data-toggle="modal" data-target="#myModal" type="button">
									注册协议
						</button>
						<!-- Modal -->
