...
<HEAD>
	...
	css/demo.css" type="text/css">
	<link rel="stylesheet" href="<%=path %>
	css/zTreeStyle/zTreeStyle.css" type="text/css">
	<link type="text/css" rel="stylesheet" href="<%=path %>
	js/bootstrap/plugin/iCheck/skins/all.css" />
	<link type="text/css" rel="stylesheet" href="<%=path %>
	...
	<div class="modal" id="propertyModal">
		<div class="modal-dialog">
			<div class="modal-content">
      		 ...
      		 data-val="true" class="form-control" data-val-remote="该维护名称已存在。" data-val-remote-additionalfields="*.storeName,*.categoryId,*.skuAttrId" data-val-remote-url="<%=path %>
							skuManage/storeNameCheck.html"/>
      		...
      		data-val="true" data-val-remote="该前端名称已存在" data-val-remote-additionalfields="*.frontName,*.categoryId,*.skuAttrId" data-val-remote-url="<%=path %>
							skuManage/frontNameCheck.html" data-val-remote-type="post"/>
							<span class="help-block">
								<span data-valmsg-replace="true" data-valmsg-for="frontName" class="field-validation-valid"></span>
							</span>
						</div>
						<br>
     	...
     	图片：<input type="file"  name="selectBtn" value="选择图片" id="choosePic"/>
						...
						<div class="col-md-6 control-group">
							启用：
							<input type="radio" name="state" id="enable" value="sku_attr_enable">
						...
						<div class="col-md-6 control-group">
							查询属性：
							<input type="radio" name="isQuery" id="isQueryProperty" value="sku_true">
						...
						<div class="col-md-6 control-group">
							组合属性：
							<input type="radio" name="isCompsite" id="isGroupProperty" value="sku_true">
						...
						<div class="col-md-6 control-group">
							必选项：
							<input type="radio" name="isRequired" id="isRequiredProperty" value="sku_true">
						...
						<!--<div class="control-group">
						类型：
						<input type="radio" name="cstate" id="multiSelect">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
      		...
      		data-val="true" data-val-remote="可选项值已存在" data-val-remote-additionalfields="*.value,*.skuAttrId,*.skuOptionId" data-val-remote-url="<%=path %>
					...
					<div class="control-group picture">
						可选图片：
						<input type="button"  name="imageId" value="选择图片" id="choosePic"/>
					</div>
					<br>
					<div id="displayImg">
					...
					<div class="col-md-6 control-group">
						启用：
						<input type="radio" name="state"  value="sku_option_enable">
						<label >启用</label>
					...
					<div class="control-group">
						类型：
						<input type="radio" name="typeInfo" id="multiSelect">
						<label for="multiSelect">多选</label>
	...
	<div class="control-group  picPanel">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
      		...
      		data-val="true" data-val-remote="可选项值已存在" data-val-remote-additionalfields="*.frontName" data-val-remote-url="<%=path %>
					skuManage/valueCheck.html" data-val-remote-type="post"/>
					<span class="help-block">
						<span data-valmsg-replace="true" data-valmsg-for="frontName" class="field-validation-valid"></span>
					</span>
