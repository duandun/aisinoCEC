...
//						skuAttrId: $inputBox.attr("id")
					...
					success: function(data) {
						...
						var $stateRadio = $("input[name='state']"), $queryRadio=$("input[name='isQuery']"),
							$compsiteRadio = $("input[name='isCompsite']"), $requiredRadio = $("input[name='isRequired']");
				...
				$("#propertyModal button.commit")[0].onclick = function() {
					...
					if($("#addSkuForm").valid()) {
						...
						if(setting.status=="enable") {
							$inputBox.parent().removeClass("delete");
						}
